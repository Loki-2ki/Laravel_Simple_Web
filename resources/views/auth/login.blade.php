<x-auth-layout>
    ...
    <style>
        ...
        #radius-shape-2 {
            ...
            width: 300px;
            height: 300px;
            background: radial-gradient(#ebfcac, #e6f913);
            overflow: hidden;
        }
                    ...
                    <div class="card-body px-4 py-5 px-md-5">
                        <div class="l-form">
                            <form method="POST" action="/login">
                                @csrf
                                <h1 class="form__title">WELCOME BACK!</h1><br>
                                <div class="form__div">
                                    <input type="text" name="email" class="form__input" placeholder=" " required
                                        aria-required="true">
                                ...
                                <div class="form-check mb-3">
                                    ...
                                    <label class="form-check-label" for="remember"color="black">
                                        Remember Me
                                    </label>
                                </div>
                                <div class="form__div">
                                    ...
                                    <div class="text-center mt-3">
                                        ...
                                        <a href="/register" class="link-success text-decoration-underline ms-1">Register
                                            Now!</a>
                                    </div>
                            </form>
                        </div>
